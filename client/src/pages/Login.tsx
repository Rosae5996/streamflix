...
import { signInWithGoogle, signInWithApple, signInWithEmail } from "@/lib/supabase";
...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#0a0a0a] via-[#141414] to-[#0a0a0a] flex items-center justify-center px-4 py-8 sm:py-12">
      {/* Fondo decorativo */}
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-0 left-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-[#E50914] rounded-full blur-3xl opacity-5" />
        <div className="absolute bottom-0 right-1/4 w-64 sm:w-96 h-64 sm:h-96 bg-[#E50914] rounded-full blur-3xl opacity-5" />
      </div>
      ...
      <div className="relative w-full max-w-md">
        ...
        <div className="text-center mb-8 sm:mb-12">
          ...
          <p className="text-sm sm:text-base text-gray-400">Tu plataforma de streaming favorita</p>
        </div>

        {/* Card */}
        <div className="bg-[#1a1a1a] border border-[#333] rounded-xl sm:rounded-2xl p-6 sm:p-8 backdrop-blur-xl">
          <h2 className="text-xl sm:text-2xl font-bold text-white mb-6 sm:mb-8">Inicia sesión</h2>
